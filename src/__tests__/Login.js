...
describe("Given that I am a user on login page", () => {                                  // sur la page de connexion
  ...
  describe("When I do fill fields in incorrect format and I click on employee button Login In", () => {   // champs login/mdp au mauvais format
  ...
  describe("When I do fill fields in correct format and I click on employee button Login In", () => {   // quand tout est bon
